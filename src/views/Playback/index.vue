<template>
  ...
  >
    <div class="btn_container">
      <button @click="handlePlayback">预览</button>
      <button @click="handlePlay">{{ play ? '暂停' : '播放' }}
      </button>
      <button @click="handleRestart">重新开始</button>
      <button @click="handleSpeed(1)">加速</button>
      <button @click="handleSpeed(0)">减速</button>
            ...
            new Cesium.Entity({
              ...
              orientation: Cesium.Transforms.headingPitchRollQuaternion(
                ...
                new Cesium.HeadingPitchRoll.fromDegrees(
                  Number(point.heading + action.yaw),
                  0,
                  -1 * action.pitch
                )
              ),
